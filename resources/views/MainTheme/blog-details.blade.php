                ...
                <div class="single-post row">
                    <div class="col-lg-12">
                        <div class="feature-img">
                            <img class="img-fluid" src="mainTheme/mainTheme/img/blog/feature-img1.jpg" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <img class="img-fluid" src="mainTheme/img/blog/post-img1.jpg" alt="">
                            </div>
                            <div class="col-6">
                                <img class="img-fluid" src="mainTheme/img/blog/post-img2.jpg" alt="">
                            </div>
                ...
                <div class="navigation-area">
                    <div class="row">
                        <div
                            ...
                            <div class="thumb">
                                <a href="#">
                                    <img class="img-fluid" src="mainTheme/img/blog/prev.jpg" alt="">
                                </a>
                            </div>
                            <div class="arrow">
                                <a href="#">
                        ...
                        <div
                            ...
                            <div class="thumb">
                                <a href="#">
                                    <img class="img-fluid" src="mainTheme/img/blog/next.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="comments-area">
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="mainTheme/img/blog/c1.jpg" alt="">
                                </div>
                                <div class="desc">
                                    <h5>
                    ...
                    <div class="comment-list left-padding">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="mainTheme/img/blog/c2.jpg" alt="">
                                </div>
                                <div class="desc">
                                    <h5>
                    ...
                    <div class="comment-list left-padding">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="mainTheme/img/blog/c3.jpg" alt="">
                                </div>
                                <div class="desc">
                                    <h5>
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="mainTheme/img/blog/c4.jpg" alt="">
                                </div>
                                <div class="desc">
                                    <h5>
                                        <a href="#">Maria Luna</a>
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="mainTheme/img/blog/c5.jpg" alt="">
                                </div>
                                <div class="desc">
                                    <h5>
                                        <a href="#">Ina Hayes</a>
            ...
            <div class="col-lg-4">
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget author_widget">
                        <img class="author_img rounded-circle" src="mainTheme/img/blog/author.png" alt="">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            <img src="mainTheme/img/blog/popular-post/post1.jpg" alt="post">
                        ...
                        <div class="media post_item">
                            <img src="mainTheme/img/blog/popular-post/post2.jpg" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                        ...
                        <div class="media post_item">
                            <img src="mainTheme/img/blog/popular-post/post3.jpg" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                        ...
                        <div class="media post_item">
                            <img src="mainTheme/img/blog/popular-post/post4.jpg" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                    ...
                    <aside class="single_sidebar_widget ads_widget">
                        <a href="#">
                            <img class="img-fluid" src="mainTheme/img/blog/add.jpg" alt="">
                        </a>
                        <div class="br"></div>
                    </aside>
