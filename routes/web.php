...
Route::post('/updateProducts/{id}', 'ProductsController@product_update')->name('updateProductsPost');
Route::post('/delete/{id}', 'ProductsController@product_delete')->name('deleteProduct');
